...
{
    public partial class Frm_Especies_Modal : BaseModal
    {
        private TextBox txtNombre;
        private ComboBox cboEstado;
        private Label lblNom, lblEst;

        public Cls_Especies ObjetoResultado { get; set; }
        private int _especieId = 0;

        public Frm_Especies_Modal(Cls_Especies obj = null)
        {
            InitializeComponentCustom();
            if (obj != null)
            {
                lblModalTitle.Text = "EDITAR ESPECIE";
                _especieId = obj.EspecieId;
                txtNombre.Text = obj.NombreEspecie;
                SetComboValue(obj.EstadoId);
            }
            else
            {
                lblModalTitle.Text = "NUEVA ESPECIE";
                _especieId = 0;
            }
        }
        ...
        private void InitializeComponentCustom()
        {
            ...
            lblNom = new Label { Text = "Nombre:", Location = new Point(startX, startY), AutoSize = true, Font = new Font("Segoe UI", 9) };
        ...
        private void BtnAccept_Click(object sender, EventArgs e)
        {
            ...
            ObjetoResultado = new Cls_Especies
            {
